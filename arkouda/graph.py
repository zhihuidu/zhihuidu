...
@typechecked
def graph_cc(graph: Union[GraphD,GraphDW,GraphUD,GraphUDW]) -> pdarray:
    """
    This function generates the connected components of a graph and its 
    histogram.
    Parameters 
    ----------
    ...
    -------
    pdarray
        The histogram values for each connected component size.
