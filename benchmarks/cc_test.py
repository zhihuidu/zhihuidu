...
if __name__ == "__main__":
    ...
    # Graph1 = ak.graph_file_read(78,34,2,1,"/rhome/oaa9/ArkoudaExtension/testingFiles/data/graphs/soc-karate.mtx")
    # Graph1 = ak.graph_file_read(13,10,2,0,"/rhome/oaa9/ArkoudaExtension/testingFiles/data/graphs/simple2.txt")
    Graph1 = ak.graph_file_read(6,8,2,0,"/rhome/oaa9/ArkoudaExtension/testingFiles/data/graphs/line2.txt")
    # Graph2 = ak.graph_file_read(5,7,3,0,"/rhome/oaa9/ArkoudaExtension/testingFiles/data/graphs/line3.txt")
    # print(Graph)
    # Graph2 = ak.graph_file_read(13,10,2,1,"/rhome/oaa9/ArkoudaExtension/testingFiles/data/graphs/simple2.txt")
    # print(Graph)
    cc1 = ak.graph_cc(Graph1)
    # cc2 = ak.graph_cc(Graph2)
